...
public abstract class CreeperUtils {
   ...
   * @return An array containing the elements of both arrays in the correct order.
   */
   ...
   * @param elements The elements to be added in the HashSet.
  ...
  /**
   * Delay the block's replacement until it is possible for it to spawn, or drop it after a
   * reasonable amount of tries.
   *
   * @param block The block to be replaced later
   * @param reason How was this block replaced
   */
  public static void delayReplacement(
      Replaceable block, CHBlockHealEvent.CHBlockHealReason reason) {
