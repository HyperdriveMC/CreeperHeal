...
public class ReplacementTimer {
   ...
   * Constructor.
   *
   * @param time The time at which the entity should be replaced.
   * @param timed Whether the replacement is in a world where replacements are timed, i.e. happen at
   *     a certain hour of the Minecraft day.
   */
   ...
   *
   * @param delay The amount of time to postpone by, in milliseconds.
   ...
   *
   * @return The recorded time. Either the time the block was burnt or later if the replacement has
   *     been delayed.
   */
  public Date getTime() {
    return time;
  ...
  /**
   * Get whether the replacement is in a world with timed repairs (repairs at a specific hour).
   *
