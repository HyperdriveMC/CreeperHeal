 ...
 * created by Creepers or TNT, but in a natural way, one block at a time, over time.
 *
 * @author nitnelave
 */
public class CreeperHeal extends JavaPlugin {
  ...
  private void registerEvents() {
    ...
    if (CreeperConfig.getBool(CfgVal.LEAVES_VINES)) pm.registerEvents(new LeavesListener(), this);
